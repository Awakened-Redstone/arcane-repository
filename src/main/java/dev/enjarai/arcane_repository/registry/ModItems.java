...
import dev.enjarai.arcane_repository.registry.item.page.action.BuildingActionPage;
import dev.enjarai.arcane_repository.registry.item.page.action.FeedingActionPage;
import dev.enjarai.arcane_repository.registry.item.page.attribute.*;
import dev.enjarai.arcane_repository.registry.item.page.type.*;
import dev.enjarai.arcane_repository.registry.item.page.type.storage.BlockStorageTypePage;
